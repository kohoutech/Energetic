...
namespace Kohoutech.OBOE
{
    public class Oboe
    {
        ...
        public Dictionary<string, Section> sectionNames;
        public static Dictionary<uint, Section> loaders = new Dictionary<uint, Section>();

        public Oboe()
        {
            sections = new List<Section>();
            sectionNames = new Dictionary<string, Section>();
        }
